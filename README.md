...
``` Charts for Visualization (Pie, Column, Scatter)
...
Toys & Games: 4.5 (1 product, low discount)
...
Electronics lead in product count, total revenue, and customer reviews. This highlights a strong opportunity to optimize premium electronic listings and ensure adequate inventory management.

Discounts Don’t Equal High Ratings
Analysis shows that heavily discounted products don’t necessarily perform better in ratings. Apply targeted discount strategies only on high-quality or trending items to protect margins while boosting performance.

Price Sensitivity Above ₹500
Products priced above ₹500 contribute the largest share of revenue, indicating a demand for value-based products. Highlight durability, functionality, and user benefits in product descriptions.

Quality Outweighs Discounts in Customer Sentiment
Customers value product quality, delivery speed, and secure packaging more than discounts. Focus on verified quality assurance and efficient fulfillment to drive better sentiment and reviews.

Niche Categories Hold Potential
Underrepresented categories like Toys show surprisingly strong performance. There’s clear potential to explore niche markets and diversify the product portfolio for broader reach.
